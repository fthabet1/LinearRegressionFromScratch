...
from LinearRegression.models.Ridge import Ridge
...
studentData.drop("Extracurricular Activities", axis=1, inplace=True)
...
# DROPPING 10 WORST FEATURES
# carPriceData.drop(["Ford", "Fourth&AboveOwner", "Renault", "Mahindra", "TrustmarkDealer", "Diesel", "LPG", "SecondOwner", "ThirdOwner", "Dealer", "Automatic"], axis=1, inplace=True)
...
for i in range(len(datasets)):
    ...
    for lambda_ in lambda_values:
        ...
        CV_model.setLambda(lambda_, X.shape[0])
